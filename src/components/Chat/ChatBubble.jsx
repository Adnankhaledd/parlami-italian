        ...
        {showText && message.corrections && message.corrections.length > 0 && (
          <div className="mt-3 pt-3 border-t border-navy-600/30">
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <span className="text-xs font-semibold text-coral">Corrections</span>
            </div>
              ...
              {message.corrections.map((correction, i) => (
                <div key={i} className="text-xs">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <CorrectionHighlight correction={correction} />
                  </div>
                  <p className="text-navy-600 text-xs pl-1">{correction.explanation}</p>
                </div>
              ))}
            </div>
          </div>
